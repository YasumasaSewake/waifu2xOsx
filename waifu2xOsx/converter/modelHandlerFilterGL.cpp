...
bool w2xc::Model::loadGLShader( std::string &resourcePath )
{
  ...
  std::string waifu2x_vsPath = resourcePath + "/waifu2x_vs.glsl";
  std::string waifu2x_fsPath = resourcePath + "/waifu2x_fs.glsl";
  
	if (!loadShader(preDefine.str().c_str(), waifu2x_vsPath.c_str(), waifu2x_fsPath.c_str(), &shader.program)) {
